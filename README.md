[![Kotlin](https://jb.gg/badges/official.svg)](https://kotlinlang.org)
...
Select Maven for Project, Kotlin for Language, 3.0.2 for Spring Boot Version, Add Rest Repositories, Spring Data JPA and HyperSQL Database for dependencies
